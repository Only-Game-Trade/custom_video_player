...
@property(nonatomic, strong) NSNumber * textureId;
@property(nonatomic, strong) NSArray<NSNumber *> * pausePointsInMilliseconds;
@end
...
- (void)clearAllPausePoints:(FLTTextureMessage *)msg error:(FlutterError *_Nullable *_Nonnull)error;
@end
