...
// #region auto-pause
@interface FLTVideoPlayer : NSObject <FlutterTexture, FlutterStreamHandler, FVPPausePointManagerDelegate>
// #endregion auto-pause
...
// #region auto-pause
@property(nonatomic, strong) FVPPausePointManager *pausePointManager;
// #endregion auto-pause
...
- (instancetype)initWithPlayerItem:(AVPlayerItem *)item
  ...
  // #region auto-pause
  _pausePointManager = [[FVPPausePointManager alloc] initWithPlayer:_player];
  _pausePointManager.delegate = self;
  // #endregion auto-pause
...
- (void)pausePointReachedAtPosition:(int64_t)positionInMilliseconds {
  if (_eventSink != nil) {
    _eventSink(@{@"event" : @"autoPause", @"position" : @(positionInMilliseconds)});
  }
}

- (void)setPausePoints:(NSArray<NSNumber *> *)pausePointsInMilliseconds {
  [_pausePointManager setPausePoints:pausePointsInMilliseconds];
}

- (void)clearAllPausePoints {
  [_pausePointManager clearAllPausePoints];
}
// #endregion auto-pause
...
- (void)disposeSansEventChannel {
  ...
  // #region auto-pause
  if (_pausePointManager) {
    [_pausePointManager dispose];
  }
  // #endregion auto-pause
...
// #region auto-pause
- (void)setPausePoints:(FLTPausePointsMessage *)input
                 error:(FlutterError *_Nullable __autoreleasing *)error {
  FLTVideoPlayer *player = self.playersByTextureId[input.textureId];
  [player setPausePoints:input.pausePointsInMilliseconds];
}

- (void)clearAllPausePoints:(FLTTextureMessage *)input
                      error:(FlutterError *_Nullable __autoreleasing *)error {
  FLTVideoPlayer *player = self.playersByTextureId[input.textureId];
  [player clearAllPausePoints];
}
// #endregion auto-pause
