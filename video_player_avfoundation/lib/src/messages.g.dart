...
class PausePointsMessage {
  PausePointsMessage({
    required this.textureId,
    required this.pausePointsInMilliseconds,
  });
  ...
  Object encode() {
    return <Object?>[
      textureId,
      pausePointsInMilliseconds,
    ];
  }

  static PausePointsMessage decode(Object result) {
    result as List<Object?>;
    return PausePointsMessage(
      textureId: result[0]! as int,
      pausePointsInMilliseconds: (result[1] as List<Object?>?)!.cast<int?>(),
    );
  }
}
...
class AVFoundationVideoPlayerApi {
  ...
  Future<void> clearAllPausePoints(TextureMessage arg_msg) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
