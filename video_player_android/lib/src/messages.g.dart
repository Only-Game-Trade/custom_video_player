...
class AutoPauseTriggeredEvent extends PlatformVideoEvent {
  ...
  static AutoPauseTriggeredEvent decode(Object result) {
    result as List<Object?>;
    return AutoPauseTriggeredEvent(
  ...
  // ignore: avoid_equals_and_hash_code_on_mutable_classes
  bool operator ==(Object other) {
    if (other is! AutoPauseTriggeredEvent || other.runtimeType != runtimeType) {
      return false;
    }
    if (identical(this, other)) {
      return true;
...
class _PigeonCodec extends StandardMessageCodec {
  ...
  void writeValue(WriteBuffer buffer, Object? value) {
    if (value is int) {
      ...
      buffer.putUint8(134);
      writeValue(buffer, value.encode());
    }    else if (value is AutoPauseTriggeredEvent) {
      buffer.putUint8(135);
      writeValue(buffer, value.encode());
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      ...
      case 135: 
        return AutoPauseTriggeredEvent.decode(readValue(buffer)!);
      case 136: 
...
class VideoPlayerInstanceApi {
  ...
  Future<void> setPausePoints(List<int> pausePointsInMilliseconds) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.video_player_android.VideoPlayerInstanceApi.setPausePoints$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
    );
    final Future<Object?> pigeonVar_sendFuture = pigeonVar_channel.send(<Object?>[pausePointsInMilliseconds]);
    final pigeonVar_replyList = await pigeonVar_sendFuture as List<Object?>?;
    if (pigeonVar_replyList == null) {
      throw _createConnectionError(pigeonVar_channelName);
    } else if (pigeonVar_replyList.length > 1) {
  ...
  Future<void> clearAllPausePoints() async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.video_player_android.VideoPlayerInstanceApi.clearAllPausePoints$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
