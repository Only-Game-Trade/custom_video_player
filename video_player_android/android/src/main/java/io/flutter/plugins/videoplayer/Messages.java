...
public class Messages {
  ...
  /** Generated class from Pigeon that represents data sent in messages. */
  public static final class PausePointsMessage {
    private @NonNull Long textureId;
    ...
    private @NonNull List<Long> pausePointsInMilliseconds;

    public @NonNull List<Long> getPausePointsInMilliseconds() {
      return pausePointsInMilliseconds;
    }

    public void setPausePointsInMilliseconds(@NonNull List<Long> setterArg) {
      if (setterArg == null) {
        throw new IllegalStateException("Nonnull field \"pausePointsInMilliseconds\" is null.");
      }
      this.pausePointsInMilliseconds = setterArg;
    }
    ...
    public static final class Builder {
      ...
      private @Nullable List<Long> pausePointsInMilliseconds;

      public @NonNull Builder setPausePointsInMilliseconds(@NonNull List<Long> setterArg) {
        this.pausePointsInMilliseconds = setterArg;
        return this;
      }
      ...
      public @NonNull PausePointsMessage build() {
        ...
        pigeonReturn.setTextureId(textureId);
        pigeonReturn.setPausePointsInMilliseconds(pausePointsInMilliseconds);
        return pigeonReturn;
      }
    }
    ...
    ArrayList<Object> toList() {
      ArrayList<Object> toListResult = new ArrayList<Object>(2);
      toListResult.add(textureId);
      toListResult.add(pausePointsInMilliseconds);
      return toListResult;
    }

    static @NonNull PausePointsMessage fromList(@NonNull ArrayList<Object> list) {
      PausePointsMessage pigeonResult = new PausePointsMessage();
      Object textureId = list.get(0);
      pigeonResult.setTextureId((textureId == null) ? null : ((textureId instanceof Integer) ? (Integer) textureId : (Long) textureId));
      Object pausePointsInMilliseconds = list.get(1);
      pigeonResult.setPausePointsInMilliseconds((List<Long>) pausePointsInMilliseconds);
      return pigeonResult;
    }
  }
  ...
  private static class AndroidVideoPlayerApiCodec extends StandardMessageCodec {
    ...
    protected Object readValueOfType(byte type, @NonNull ByteBuffer buffer) {
      switch (type) {
        ...
        case (byte) 131:
          return PausePointsMessage.fromList((ArrayList<Object>) readValue(buffer));
        case (byte) 132:
    ...
    protected void writeValue(@NonNull ByteArrayOutputStream stream, Object value) {
      ...
      } else if (value instanceof PausePointsMessage) {
        stream.write(131);
        writeValue(stream, ((PausePointsMessage) value).toList());
  ...
  public interface AndroidVideoPlayerApi {
    ...
    void clearAllPausePoints(@NonNull TextureMessage msg);
    ...
    static void setup(@NonNull BinaryMessenger binaryMessenger, @Nullable AndroidVideoPlayerApi api) {
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.AndroidVideoPlayerApi.setPausePoints", getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<Object>();
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.AndroidVideoPlayerApi.clearAllPausePoints", getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<Object>();
                ...
                TextureMessage msgArg = (TextureMessage) args.get(0);
                try {
                  api.clearAllPausePoints(msgArg);
                  wrapped.add(0, null);
                }
 catch (Throwable exception) {
                  ArrayList<Object> wrappedError = wrapError(exception);
